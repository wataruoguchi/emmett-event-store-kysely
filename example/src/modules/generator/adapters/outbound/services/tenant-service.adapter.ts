/**
 * Tenant Service Adapter - Adapts the Tenant module's port to Generator module's needs
 ...
 * This allows the Generator module to depend on its own interface rather than Tenant's directly
 */
